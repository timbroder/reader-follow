...
DATABASES = {
    'default': {
        ...
        'NAME': 'readerfollow',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '-qo56qlij0escpxv4br#%p73&viww8_@9vdme&lb7gu=%pdxtn'
...
vars()['GOOGLE-OAUTH2_AUTH_EXTRA_ARGUMENTS'] = {'access_type': 'offline', 'approval_prompt': 'force'}
